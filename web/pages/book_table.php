...
$postid = $sel[$i]['id'];
$img = !$sel[$i]['img'] ? $bookdefaultimg : SITE_URL.'media/'. $sel[$i]['img'];
?>
...
<td><a href="/writer?id=<?=$sel[$i]['writer']?>"><?=$sel[$i]['writername'] != null ? $sel[$i]['writername'] : ''?></a></td>
<td><a href=" data[i]['booklink']?>"><?=$sel[$i]['title']?></a></td>
<td><a href="/cat?id=<?=$sel[$i]['cat']?>"><?=$sel[$i]['catname']!= null ? $sel[$i]['catname'] : ''?></a></td>
<td><a href="/editor?id=<?=$sel[$i]['editor']?>"><?=$sel[$i]['editorname'] != null ? $sel[$i]['editorname'] : ''?></a></td>
<td><?=$G['book_status'][$sel[$i]['status']]?></td>
<td><?=$G['isread'][$sel[$i]['isread']]?></td>
