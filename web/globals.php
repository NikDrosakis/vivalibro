...
/*
  ...
  *
  * */
$TEMPLATE=$bot->f("SELECT en FROM globs WHERE name='template_active'")['en'];
//PRESERVED page URIS
$GLOBAL_URI=array("index","app","post","tax","tag","search","user","login","register","dsh","archieve","404","gaia");
$POST_URI=$bot->fl("uri","post");
$TAX_URI=$bot->fl("name","tax");
$USER_URI=$bot->fl("name","user");
//$PAGE_URI=$bot->fl("uri","page");
