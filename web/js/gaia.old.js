...
//API
const api={
    uri:"https://vivalibro.gr/api/",version:2.0,port:3005,
...
s.setup={
    ...
    gaia_update_button:function(appendid){
        ...
        g.cors("https://vivalibro.gr:6984/gaia/_find",JSON.stringify(find),function(res){
    ...
    template_update_button:function(template,appendid){
        ...
        g.cors("https://vivalibro.gr:6984/templates/_find",JSON.stringify(find),function(res){
            console.log(res.docs[0]._id);
